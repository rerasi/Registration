...
<body>
	<div class="form_box">
	<div style="font-family:'Bauhaus 93'; font-size:35px;">WELCOME!</div><br>
		<form action="View" method="post">	 
			...
			<div>
		    	<label style="margin-left: 192px;">Male</label>
			   	<input type="radio" name="radio" value="1" checked="checked" style="margin-left: -260px; margin-top: 52px;">
			</div>
			<div>
				<label style="margin-left: 200px;">Female</label>
			    <input type="radio" name="radio" value="2" style="margin-left: -460px; margin-top: 18px;">
			</div>
		      <br><br>
